                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="card bg-white shadow-sm border border-gray-100 p-6">
                        <div class="form-control w-full mb-4">
                            ...
                            <input type="text" name="title" value="{{ old('title', $page->title) }}" placeholder="Ketik judul halaman di sini..." class="input input-bordered w-full @error('title') input-error @enderror" required />
                            @error('title')
                        ...
                        <div class="form-control w-full mb-4">
                            ...
                            <input type="text" name="slug" value="{{ old('slug', $page->slug) }}" placeholder="url-halaman-otomatis-jika-kosong" class="input input-bordered w-full text-sm" />
                            @error('slug')
                                <span class="text-xs text-rose-600 mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-control w-full">
                            ...
                            <textarea id="page-content" name="content" class="hidden">{{ old('content', $page->content) }}</textarea>
                            @error('content')
                                <span class="text-xs text-rose-600 mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="card bg-white shadow-sm border border-gray-100 p-6">
                        ...
                        <div class="form-control w-full mb-4">
                            ...
                            <input type="text" name="seo_title" value="{{ old('seo_title', $page->seo_title) }}" placeholder="Judul khusus untuk hasil pencarian Google" class="input input-bordered w-full text-sm" />
                        </div>

                        <div class="form-control w-full">
                            <label class="label font-medium text-gray-700">SEO Description</label>
                            <textarea name="seo_description" rows="3" placeholder="Deskripsi khusus untuk Google snippet" class="textarea textarea-bordered w-full text-sm">{{ old('seo_description', $page->seo_description) }}</textarea>
                        </div>
                    </div>
                </div>
