                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="card bg-white shadow-sm border border-gray-100 p-6">
                        <div class="form-control w-full mb-4">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" placeholder="Ketik judul berita di sini..." class="input input-bordered w-full @error('title') input-error @enderror" required />
                            @error('title')
                        ...
                        <div class="form-control w-full mb-4">
                            ...
                            <input type="text" name="slug" value="{{ old('slug') }}" placeholder="url-berita-otomatis-jika-kosong" class="input input-bordered w-full text-sm" />
                            @error('slug')
                                <span class="text-xs text-rose-600 mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-control w-full mb-4">
                            ...
                            <textarea name="excerpt" rows="3" placeholder="Ringkasan berita singkat..." class="textarea textarea-bordered w-full text-sm">{{ old('excerpt') }}</textarea>
                            @error('excerpt')
                                <span class="text-xs text-rose-600 mt-1">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="card bg-white shadow-sm border border-gray-100 p-6">
                        ...
                        <div class="flex gap-2">
                            <button type="submit" class="btn btn-primary flex-1">Simpan Berita</button>
